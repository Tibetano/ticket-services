...
import com.anigame.ticket_services.infrastructure.clients.EfiPayPixAuthClient;
...
public class EfiPixTokenService {

    private final EfiPayPixAuthClient authClient;
    ...
    private void refreshToken() {
        ...
        TokenResponse response = authClient.login(
                "Basic " + base64,
                Map.of(
                        "grant_type",
                        "client_credentials"
