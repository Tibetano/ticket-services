...
VALUES ('4a9fbad4-5d8f-43e3-914e-38ba7e53eb75','88662959-7fe3-4687-92b9-7a587381466c','01','2026-4-4','2026-6-6','ACTIVE')
ON CONFLICT (id) DO NOTHING;
...
VALUES ('5ca392a8-c3fc-423d-8d78-d8acd59452bf','4a9fbad4-5d8f-43e3-914e-38ba7e53eb75','FULL',600,15,0,0)
ON CONFLICT (id) DO NOTHING;

INSERT INTO ticket_services.ticket_batch_type (id,ticket_batch_id,ticket_type,price,total_quantity,sold_quantity,reserved_quantity)
VALUES ('c32f4e7b-ecfd-4ef8-9832-f1f697915be8','4a9fbad4-5d8f-43e3-914e-38ba7e53eb75','HALF',300,5,0,0)
ON CONFLICT (id) DO NOTHING;
